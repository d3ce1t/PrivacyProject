...
void Viewer::printMessage(const nite::UserData &user, uint64_t ts, const char *msg)
{
...
void Viewer::setDrawStatusLabelFlag(bool value) {
    g_drawStatusLabel = value;
    emit changeOfStatus();
}

void Viewer::setDrawHistogramFlag (bool value) {
    g_drawHistogram = value;
    emit changeOfStatus();
}

void Viewer::setDrawFrameIdFlag(bool value) {
    g_drawFrameId = value;
    emit changeOfStatus();
}
